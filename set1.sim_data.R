...
mat.generate.asw <- function(p.con,nvar,AR,dens,p.group,con.b,lag.b){
  repeat{
    ...
    indices <- which(Phi == 0, arr.ind = TRUE)        ###create data frame that lists all combinations of columns/rows in matrices. Run "indices <- indices[which(indices[,1] != indices[,2]), ]" to kick out diagonal # nolint
...
dir.create('C:/Users/tasha/Dropbox (Personal)/Research Projects/CIFAR/230328_Sim_Study/set1.balanced_in')
data.path <- 'C:/Users/tasha/Dropbox (Personal)/Research Projects/CIFAR/230328_Sim_Study/set1.balanced_in/data'
true.path <- 'C:/Users/tasha/Dropbox (Personal)/Research Projects/CIFAR/230328_Sim_Study/set1.balanced_in/true'
level.path <- 'C:/Users/tasha/Dropbox (Personal)/Research Projects/CIFAR/230328_Sim_Study/set1.balanced_in/levels'
