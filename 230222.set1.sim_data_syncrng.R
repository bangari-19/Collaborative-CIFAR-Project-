...
ts.generate.asw <- function (mat, lvl, t,dens,p.group,con.b,lag.b,p.con) {
  repeat {
    repeat{
      ...
      # hii   <- A[noise.inds] + rnorm(n = nrow(noise.inds), mean = 0, sd = .01)
      # print(hii)
      A[noise.inds]   <- A[noise.inds] + syncrng.box.muller(0, 0.01, n=nrow(noise.inds))
      # hii   <- A[noise.inds] + syncrng.box.muller(0, 0.01, n=nrow(noise.inds))
      # print(hii)
      # print(wut)
...
dir.create('/Users/reneehlozek/Dropbox/CIFAR_Sims/230222_syncrng')
data.path <- '/Users/reneehlozek/Dropbox/CIFAR_Sims/230222_syncrng/data'
true.path <- '/Users/reneehlozek/Dropbox/CIFAR_Sims/230222_syncrng/true'
level.path <- '/Users/reneehlozek/Dropbox/CIFAR_Sims/230222_syncrng/levels'
